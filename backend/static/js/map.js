...
function show_dets_marker(contact){
    ...
    if (contact.status != null){
        showtext += "<br><div style='background-color:" + status_icon_colormap.get(contact.status) + ";'>" + capitalize(String(contact.status)) + " </div> ";
    ...
    if (contact.current_loc != null){
        showtext += "<br><br>LAT: " + String(contact.current_loc[0]) + " LON: " + String(contact.current_loc[1]) + "";
    }
    if (contact.heading != null){
        showtext += "<br><br>HEADING: " + contact.heading + "";
    }
    // if (contact.last_report_time != null){
    //     showtext += "LAST REPORTED: " + String(contact.last_report_time) + "<br><br>"
    // }
    if (contact.speed != null){
        showtext += "<br><br>SPEED: " + String(contact.speed) + "";
    }
